    ...
    @if ($posts->count())
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb-3">
                        <p class="position-absolute px-3 py-2" style="background-color: rgba(0, 0, 0, 0)"><a href="/artikel?category={{ $post->category->slug }}" class="text-decoration-none text-white">{{ $post->category->name }}</a></p>
                        @if ($post->image)
