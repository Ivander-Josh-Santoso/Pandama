            ...
            <div class="col d-flex justify-content-end">
              <div class="social-media">
                <p class="mb-0 d-flex">
                    ...
                    <a href="https://www.instagram.com/elogion_wah/" class="d-flex align-items-center justify-content-center"><span style="color: rgb(34, 139, 34)"><i class="bi bi-instagram"></i></span></a>
                    <a href="https://www.youtube.com/channel/UCrhuQ2wCmgnKgA3TyP6hrtQ" class="d-flex align-items-center justify-content-center"><span style="color: rgb(34, 139, 34)"><i class="bi bi-youtube"></i></span></a>
                    <a href="mailto:annurriyadhus17@gmail.com" class="d-flex align-items-center justify-content-center"><span style="color: rgb(34, 139, 34)"><i class="bi bi-envelope-fill"></i></span></a>
                </p>
              </div>
            </div>
        </div>
      ...
      <div class="container-fluid px-5">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto mr-md-3">
            ...
            <li class="nav-item {{ ($title === "Disewakan") ? 'active' : '' }}"><a href="/jual" class="nav-link fw-bold" style="font-size: 12px">Disewakan</a></li>
