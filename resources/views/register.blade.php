                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        <div class="row mb-4 px-3">
                            ...
                            <div class="twitter text-center mr-3"><div class="fa fa-instagram"></div></div>
                            <div class="linkedin text-center mr-3"><div class="fa fa-youtube"></div></div>
                        </div>
                        ...
                        <form action="/register" method="POST">
                            ...
                            <div class="row px-3 mb-4">
                                ...
                                <input type="text" name="no_hp" class="form-control" id="no_hp" placeholder="ex: +62878XXXXXXXX">
                                @error('no_hp') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div> 
                            ...
                            <div class="row mb-3 px-3">
                                <button type="submit" class="btn btn-dark text-center rounded-0 fw-bolder" style="background-color: rgb(34, 139, 34)">Register</button>
                            </div>
                        </form>
                        <div class="row mb-4 px-3">
