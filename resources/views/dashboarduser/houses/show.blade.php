...
<div class="container">
    <div class="row my-3">
        <div>
                <a href="/user/dashboard/houses" class="btn btn-success rounded-1"><i class="bi bi-arrow-left"></i> Back</a>
                <a href="/user/dashboard/houses/{{ $house->slug }}/edit" class="btn btn-warning rounded-1"><i class="bi bi-pencil-square"> Edit</i></a>
                ...
                <hr>
                <h2 class="fw-bold">{{ $house->nama_wisma }}</h2>
                <section id="house">
                        <div class="row">
