...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Guesthouses</h1>
</div>

<!-- Table -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark">Guesthouses Data</h6>
    </div>
    <div class="card-body">
        <a href="/dashboardadmin/houses/create" class="btn text-white rounded-5 mb-3" style="background-color: rgb(34, 139, 34);">Add Listing</a>
