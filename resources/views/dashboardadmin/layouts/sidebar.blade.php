<ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: rgb(34, 139, 34);" id="accordionSidebar">

    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboardadmin">
        <div class="sidebar-brand-text mx-3">PANDAMA Admin</div>
    </a>
